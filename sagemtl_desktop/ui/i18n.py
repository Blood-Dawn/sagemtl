...
_TRANSLATIONS = {
    "en": {
        ...
        "mode.novels": "Novels",
        "mode.manga": "Manga",
        "action.manga_add_url": "➕ Add Series by &URL...",
        "action.manga_search": "🔎 &Search Source...",
        "action.manga_translate": "🌐 &Translate Chapter(s)",
        "action.manga_open_reader": "📖 Open &Reader",
        "action.manga_studio": "🎨 Open in &Studio...",
        "action.manga_export": "💾 &Export CBZ/PDF...",
        "action.manga_settings": "⚙️ Manga &Settings...",
        "manga.reader.before": "Before",
        "manga.reader.after": "After",
        "manga.reader.show_regions": "Show regions",
        "manga.series_list.title": "Manga Library",
        "manga.empty": "No manga series yet. Use Manga > Add Series by URL.",
    },
    "es": {
        "menu.file": "&Archivo",
        "menu.edit": "&Editar",
        ...
        "mode.novels": "Novelas",
        "mode.manga": "Manga",
        "action.manga_add_url": "➕ Agregar serie por &URL...",
        "action.manga_search": "🔎 &Buscar en fuente...",
        "action.manga_translate": "🌐 &Traducir capitulo(s)",
        "action.manga_open_reader": "📖 Abrir &lector",
        "action.manga_studio": "🎨 Abrir en &Studio...",
        "action.manga_export": "💾 &Exportar CBZ/PDF...",
        "action.manga_settings": "⚙️ &Ajustes de manga...",
        "manga.reader.before": "Antes",
        "manga.reader.after": "Despues",
        "manga.reader.show_regions": "Mostrar regiones",
        "manga.series_list.title": "Biblioteca de manga",
        "manga.empty": "Aun no hay series. Use Manga > Agregar serie por URL.",
    },
}
